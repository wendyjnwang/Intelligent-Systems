...
public class Tiles implements State {
	...
	public boolean equals(State s) {
		...
		if (getClass()!=s.getClass())
			return false; 
		final Tiles other = (Tiles)s;
		if (this.width == other.getWidth()&& this.emptyTileRow == other.getEmptyTileRow()
				&& this.emptyTileColumn == other.getEmptyTileColumn()
	...
	@Override
	public int hashCode() {
		int result = width*31 + emptyTileRow*17 + emptyTileColumn *4 + tiles.toString().hashCode();
		return result; 
	}
}
